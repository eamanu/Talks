...
\newcommand{\email}{eamanu@members.fsf.org} % Presenter's email address
...
\begin{frame}
	% This environment simply prints a series of bullet points
	\framedsl{¿Que me puede dar el FOSS?}
\end{frame}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{images/gimp2}
	\label{fig:gimp2}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{images/metting1}
	\caption{}
	\label{fig:metting1}
\end{figure}
\end{frame}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{images/meetting2}
	\caption{}
	\label{fig:meetting2}
\end{figure}
\end{frame}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{images/meetting3}
	\caption{}
	\label{fig:meetting3}
\end{figure}
\end{frame}
