...
\newcommand{\titlephrase}{Primera Reunión de la Comunidad Local de Software Libre y Código Abierto de La Rioja} % Presentation title
...
\begin{document}
	...
	\begin{frame}
	\centering
	\includegraphics[scale=0.25]{Feria-del-libro-2019.jpg}	
\end{frame}
...
\fbckg{1.jpg} % Slide background image
\begin{frame}
\framedsl{¿Cómo puedo asegurarme que no robarán mi creación?} 
\end{frame}
...
\fbckg{empresas.jpg} % Slide background image
\begin{frame}
%\framedsl{¿Cómo puedo armar mi negocio sobre software libre?} 
\end{frame}
...
\fbckg{1.jpg} % Slide background image
\begin{frame}
\framedsl{¿Cómo puedo ayudar en el software libre?} 
\end{frame}
...
\fbckg{1.jpg} % Slide background image
\begin{frame}
\framedsl{¿Por qué deberíamos usar Sotfware Libre?} 
\end{frame}

\fbckg{blank.jpg} % Slide background image
\begin{frame}
\centering
\includegraphics[scale=1]{snowden.jpg}
\end{frame}

\fbckg{blank.jpg} % Slide background image
\begin{frame}
\centering
\includegraphics[scale=0.5]{mark.jpg}
\end{frame}

\fbckg{2.jpg} % Slide background image
\begin{frame}
\framedsl{Si usamos software privativo, nos podemos olvidar de nuestra privacidad.}
\end{frame}

\fbckg{2.jpg} % Slide background image
\begin{frame}
\framedsl{Además, de nuestras libertades.}
\end{frame}

\fbckg{blank.jpg} % Slide background image
\begin{frame}
\centering
\includegraphics[scale=0.5]{loves.png}
\end{frame}

\fbckg{2.jpg} % Slide background image
\begin{frame}
\framedsl{Y a veces puede ser peligroso.}
\end{frame}
